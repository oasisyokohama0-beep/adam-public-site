...
const RATE_LIMIT_KEY = 'adam:review:lastSubmitAt'
      ...
      <div className="px-[22px] pb-16">
        <div className="bg-surface border border-rule-gold p-[26px] text-center">
          ...
          <div className="mt-6">
            <Link
              href="/reviews"
              className="inline-block px-8 py-3 bg-wine text-ink font-serif tracking-[2px] text-[11px] no-underline"
            >
              VIEW REVIEWS
            </Link>
          </div>
    ...
    <form onSubmit={onSubmit} noValidate className="px-[22px] pb-16 flex flex-col gap-6">
      ...
      <div className="text-center">
        <button
          type="submit"
          disabled={pending}
          className="w-full py-3.5 bg-wine text-ink font-serif tracking-[3px] text-[12px] disabled:opacity-50"
        >
